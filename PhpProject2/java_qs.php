...
<html>
    <head>
        <meta charset="UTF-8">
        <title></title>
        <link href="java_qs.css" rel="stylesheet" type="text/css">
    </head>
    <body>
        <?php
        // put your code here
        session_start();
        require 'qsconnect2.php';
         ...
         if (isset($_POST['qs']) && isset($_POST['opt1']) && isset($_POST['opt2']) && isset($_POST['opt3']) && isset($_POST['opt4']) && isset($_POST['ans'])){
             ...
             $ins = "INSERT INTO `java`( `qs`, `opt1`, `opt2`, `opt3`, `opt4`, `ans`) VALUES ('$enter_qs' , '$enter_opt1' , '$enter_opt2' , '$enter_opt3' , '$enter_opt4' , '$enter_ans')";
        ...
        ?>
         <div class="maindiv">
            ...
            <div class="logmaindiv">
                ...
                <div class="logoutdiv" style="margin-top: 10%;"><a href="adminlogout.php" class="logout">Log Out</a></div>
            </div>
        </div>    
