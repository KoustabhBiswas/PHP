...
<html>
    <head>
        <meta charset="UTF-8">
        <title></title>
        <link href="php_qs.css" rel="stylesheet" type="text/css">
    </head>
    <body>
        <?php
        // put your code here
        ...
        require 'qsconnect3.php';
         ...
         if (isset($_POST['qs']) && isset($_POST['opt1']) && isset($_POST['opt2']) && isset($_POST['opt3']) && isset($_POST['opt4']) && isset($_POST['ans'])){
             ...
             $ins = "INSERT INTO `php`(`qs`, `opt1`, `opt2`, `opt3`, `opt4`, `ans`) VALUES ('$enter_qs' , '$enter_opt1' , '$enter_opt2' , '$enter_opt3' , '$enter_opt4' , '$enter_ans')";
